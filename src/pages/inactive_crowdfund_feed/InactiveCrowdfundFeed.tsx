...
function InactiveCrowdfundingFeed(props: any): JSX.Element {
  console.log(props);
    ...
    if (token) {
      ...
      getUnfollowedTopics(token)
        .then(async (getTopicsResponse: any) => {
          const cfs = await props.props.near.contract1.get_inactive_cfs();
...
export default InactiveCrowdfundingFeed;
